...
IxRawan.user.setStatus("Online")
       ...
       .addField('     **E#cuttweet** ' ,' ``áÚÈÉ ßÊ ÊæíÊ`` ')
       .addField('     **E#sra7a**  ' ,' ``ÇáÈæÊ íÓÆáß ÇÓÆáÉ áÇÒã ÊÌÇæÈ ÈÕÑÇÍÉ`` ')
       .addField('     **E#puzzle**  ' ,' ``ÇáÈæÊ íÌíÈáß ÇáÛÇÒ áÇÒã ÊÚÑİåÇ`` ')
       .addField('     **E#speed **  ' ,' ``ÇáÈæÊ ÑÍ íÚØíßã ßáãÉ æÇáÇÓÑÚ ÑÍ íßÊÈåÇ`` ')
	   .addField('     **E#dismantling**' ,' ``áÚÈÉ İßß`` ')
       .setColor('RANDOM')
